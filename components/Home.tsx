  ...
  return (
    <div className="flex items-center justify-center mt-14">
      <div className="flex flex-col items-center justify-center">
        <h1 className=" md:text-[68px] text-[36px] text-transparent bg-clip-text bg-gradient-to-r from-purple-400 cursor-pointer transition-all  ease-in-out to-pink-600 font-extrabold mb-4">
          Get your Dream job
        </h1>
        <h2 className="md:text-[48px] text-[28px]  text-white font-extrabold ">
        ...
        <div className="md:mt-32 mt-12  text-center  pl-3 text-gray-300 mb-32">
